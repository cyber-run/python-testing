...
class ServoControl:
    ...
    def calibrate_yaw(self, us_range=(1000, 2000), num_cycles=3, samples_per_cycle=2):
        ...
        for _ in range(num_cycles):
            for us_val in range(us_range[0], us_range[1] + 1, (us_range[1] - us_range[0]) // samples_per_cycle):
                ...
                time.sleep(5)  # Adjust sleep time as needed, small delay to be sure qualisys data pulled in correct
